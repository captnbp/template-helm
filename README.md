...
| `networkPolicy.%%COMPONENT_NAME%%.egress.toInternet.ports`                         | Internet ports to allow                                                            | `[]`                   |
...
- The `%%COMPONENT_NAME%%o` project can be found [here](https://github.com/%%COMPONENT_NAME%%o)
